...
<body>
  ...
  <!-- ======= paySection ======= -->
    ...
    padding-left: calc(var(--bs-gutter-x)* .1);">
              <form action="payment_process.php" method="post" role="form" class="" style="padding: 25px 15px;" id="paymentutr">
           ...
           <input type="email" class="form-control mt-1" name="emailid" id="emailid" value="<?php echo htmlspecialchars($email); ?>">
              ...
              <div class="text-center">
              <small style="color: #141414;margin-top: 10px;margin-bottom: 10px;font-weight: 100;font-size: 12px;">If payment failed for any reason, <a href="">click here</a> to pay again.</small>
             </div>
            </div>
          </div>
          <!--End here-->
     ...
     var amt=49;
      ...
      document.getElementById('pay-button').addEventListener('click', function() {
        ...
        var monthSelector = document.getElementById('month');
            ...
            paymentInfo.textContent = 'Pay ₹' + selectedValue*selectedMonth;
