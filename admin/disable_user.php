...
// Function to disable the user by sending a request to Jellyfin using cURL
function disableUserByUrl($serverUrl, $apiKey, $userId) {
    ...
    return $httpCode === 204; // HTTP 204 indicates a successful request with no content
}

// Function to get user ID by username using cURL
...
function ReminderEmail($dbEmail,$username) {
...
<body>
    <div class="email-container">
        ...
        <div class="footer">
            ...
            <a href="https://scoobytv.com/telegram" target="_blank">
  <img src="https://scoobytv.com/assets/img/telegram.webp" alt="telegram support" class="imgtelegram">
</a>
        ...
        if ($dbUserId) {
            ...
            if ($jellyfinUserId) {
                if (disableUserByUrl($serverUrl, $apiKey, $jellyfinUserId)) {
                   ...
                   ReminderEmail($dbEmail,$username);
