    ...
    <thead>
        <tr>
            <th>ID</th>
             ...
             <th>Email <button class="btn btn-sm btn-outline-primary copy-btn" data-column="email">Copy</button></th>
                 <th>Username <button class="btn btn-sm btn-outline-primary copy-btn" data-column="username">Copy</button></th>
                  <th>Mobile <button class="btn btn-sm btn-outline-primary copy-btn" data-column="phone">Copy</button></th>
                 <th>Created</th>
                 <th>Plan Expiry</th>
                 <th>Valid For</th>
                 <th>Plan or Paid</th>
                                        ...
                                        while ($user = $result->fetch_assoc()) {  
                                            ...
                                            <tr>
                                                ...
                                                <td class="username"><?php echo htmlspecialchars($user['username']); ?></td>
                                                    ...
                                                    <td class=""><input type="password" class="form-control password-input" value="<?php echo htmlspecialchars($user['password']); ?>" disabled><button class="btn btn-sm btn-outline-primary toggle-password" type="button"><i class="fa fa-eye" id="togglePassword"></i></button></td>
    ...
    document.addEventListener('DOMContentLoaded', () => {
        ...
        document.querySelectorAll('.copy-btn').forEach(button => {
            button.addEventListener('click', () => {
                const columnClass = button.dataset.column;
                const data = [];
                
                // Collect all data from the specific column
                ...
                navigator.clipboard.writeText(textToCopy).then(() => {
                    alert(`Copied ${columnClass} data to clipboard!`);
                }).catch(err => {
