    ...
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="nav-link scrollto" href="SPP/tutorial.php">App download</a></li>
...
echo '<tr><th></th><td><a href="http://stv1.xyz:53575" style="margin-left:10px;" class="btn btn-buy"  target="_blank">Open ScoobyTV OTT</a>';
...
<tr>
              <th>Host/Server IP</th>
              <td style="background-color:#868e96;display:flex;" >
              
              <input type="text" class="form-control" id="serveripcopy" placeholder="" value="stv1.xyz:53570" disabled style="width:80%;margin-right:20px;">
                         <a type="button" class="btn btn-outline-secondary" id="copyButtonServer" onclick="copyServer()" style="background: linear-gradient(42deg, #4a47619c 0%, #241f29 100%);">
 ...
 <tr>
  ...
  <path fill-rule="evenodd" d="M4 2a2 2 0 0 1 2-2h8a2 2 0 0 1 2 2v8a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2zm2-1a1 1 0 0 0-1 1v8a1 1 0 0 0 1 1h8a1 1 0 0 0 1-1V2a1 1 0 0 0-1-1zM2 5a1 1 0 0 0-1 1v8a1 1 0 0 0 1 1h8a1 1 0 0 0 1-1v-1h1v1a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2h1v1z"/>
            ...
            <tr>
             ...
             <tr>
              <th>Email</th>
              <td style=""><?php echo htmlspecialchars($user['email']); ?></td>
            </tr>
...
?>
  ...
  <div class="btn-wrap text-center mt-3 cust_feedback <?php echo ($user['purchase'] === 'Successfull' || $user['purchase'] === 'Successfull & Verified') ? '' : 'hidden'; ?>" ><a href="https://telegram.dog/+griOp0Ng0f4yYTBl"  target="_blank"> <img src="assets/img/join-us-in-telegram.webp" alt="Telegram Support" style="width: 170px; border-radius: 12px;background-color: #808080; opacity: 0.9;"></a></div> 
...
<!-- Modal -->
    ...
    <section id="" class="section-bg p-1 <?php echo htmlspecialchars($classdata); ?>" >
      <div class="container profile-container" data-aos="fade-up">
        ...
        <span>
    <ul>
        <li>Please wait for a few minutes to activate your OTT-ID (this usually takes 2-5 minutes, but can take up to 20 minutes).</li>
 ...
 <a href="https://play.google.com/store/apps/details?id=dev.jdtech.jellyfin"  target="_blank"><img src="assets/img/playstore.png" alt="Icon" style="width:140px;vertical-align:middle;"></a>
   ...
   <div class="container mt-4">
        <h3>Jellyfin Host/Server Information</h3>
        <p>If one Host does not work, try the alternate Host provided.</p>
...
<script src="https://maxcdn.bootstrapcdn.com/bootstrap/4.5.2/js/bootstrap.min.js"></script>
  ...
  <script>
    ...
    function copyServer() {
      var copyText = document.getElementById("serveripcopy");
      copyText.disabled = false; // Enable the input field to select the text
      copyText.select();
      copyText.setSelectionRange(0, 99999); // For mobile devices
      document.execCommand("copy");
