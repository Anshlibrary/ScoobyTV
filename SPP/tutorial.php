...
<body> 
    ...
    <div class="d-flex justify-content-between align-items-center">
       <?php
                        ...
                        if (isset($_SESSION['associate_id'])) {
                            echo '<a href="dashboard.php" class="logo"><img src="../assets/img/scoobytv_logo.png" alt="logo" class="img-fluid logo-img"></a>';
                        }else{
                            echo '<a href="../index.php" class="logo"><img src="../assets/img/scoobytv_logo.png" alt="logo" class="img-fluid logo-img"></a>';
                        }
                        ?>
 ...
 <?php
                        // Show the Sign Out button if the user is logged in
                        if (isset($_SESSION['associate_id'])) {
                            echo '<li><a href="signout.php" class="btn btn-sign" style="">Sign out</a></li>';
                        }
                        ?>
    ...
    <div class="container d-flex align-items-center justify-content-between">
      <!--<h1 class="logo"><a href="index.html"></a></h1> Text logo -->
       <?php
                        // Show the Sign Out button if the user is logged in
                        if (isset($_SESSION['associate_id'])) {
                            echo ' <h2 style="font-size: 18px;"><a href="dashboard.php" class="logo"><i class="fa fa-arrow-left"></i></a></h2>';
                        }
                        else{
                            echo ' <h2 style="font-size: 18px;"><a href="../profile.php" class="logo"><i class="fa fa-arrow-left"></i></a></h2>';
                        }
                        ?>
