...
<body>
  ...
  <!-- ======= paySection ======= -->
    ...
    padding-left: calc(var(--bs-gutter-x)* .1);">
              <form action="payment_process_v3.php" method="post" role="form" class="" style="padding: 25px 15px;" id="paymentutr">

                <div class="row">
                  <div class="" id="plan-selector">
                    <div class="section-title" style="padding-bottom: 10px;">
                      <h2 style="margin-bottom: 10px;padding-bottom: 3px;color:#0bef0b;" id="payment-info2"></h2>
                    ...
                    <div class="form-group mt-3">
                      <select id="plan" name="plan" class="form-control">
                            ...
                            <option value="89">Starter - ₹89</option>
                            <option value="99">Premium - ₹99</option>
                    ...
                    <div class="form-group" style="margin-top:25px;">
                     ...
                     <!--Apply coupon -->
                     <div class="input-group text-center" style="justify-content: center;margin-top:20px;margin-bottom:25px;">

<a href="#" class="btn btn-coupon" data-toggle="modal" data-target="#couponModal" id="couponLink" style="font-weight:500;"><img src="assets/img/coupon.png" style="height:25px;width:25px;"> Apply Coupon</a>
                       </div>
                    ...
                    <div class="my-email-form" style="border-radius: 10px;" id="scanqrupi">
                      <div class="section-title" style="padding-bottom: 5px;">
                        <h2 style="margin-bottom: 0;padding-bottom: 3px;" id="payment-info" class="success-color"></h2>
                         <input type="hidden" class="form-control mt-1" name="paid_amt" id="paid_amt" value="0" required>
                      </div>
                      <div class="text-center">
                        <p class="text-pay">Pay to below Payment options-</p>
                      </div>
              ...
              <div class="my-email-form hidden" id="fillutr">
                  ...
                  <input type="tel" class="form-control mt-1" name="utrid" id="utrid" placeholder="last 5 digits only or all digits">
                   <input type="hidden" class="form-control mt-1" name="FinalCouponCode" id="FinalCouponCode" value="NA" required>
                <div class="btn-wrap text-center mt-3" >
            ...
            <div class="modal-body">
                <form id="couponForm" style=" display: flex;align-content: center;justify-content: center;align-items: flex-end;">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="RealCouponCode" value="" placeholder="Enter Coupon Code">
                    </div>
...
<script>
 function fillCoupon(couponCode) {
        document.getElementById('RealCouponCode').value = couponCode;
    }
    </script>
