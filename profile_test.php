...
?>
  ...
  <div class="btn-wrap text-center mt-3 cust_feedback <?php echo ($user['purchase'] === 'Successfull' || $user['purchase'] === 'Successfull & Verified') ? '' : 'hidden'; ?>" ><a href="https://t.me/+griOp0Ng0f4yYTBl"  target="_blank"> <img src="assets/img/join-us-in-telegram.webp" alt="Telegram Support" style="width: 170px; border-radius: 12px;background-color: #808080; opacity: 0.9;"></a></div> 
