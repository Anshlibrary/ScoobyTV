...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    echo 'alert("Please fill the invite code.");';
    ...
    <div class="container" data-aos="fade-up">
        <div class="section-title">
            ...
            <?php if (isset($_SESSION['otp_sent'])): ?>
                <form id="edit-email-form" action="signup_test.php" method="post" style="display:inline;">
        ...
        <div class="row <?php echo $signup_class; ?>">
            <div class="col-lg-12">
                ...
                <form id="signup-form" action="signup_test.php" method="post" role="form" class="signup-email-form" style="background:linear-gradient(to bottom right, #716d6d, #141414);color:#fff;border-radius:20px;">
                    <div class="row">
...
<div id="upi-details" class="form-group" style="">
    <input type="text" id="invite-code" name="invite-code" class="form-control" placeholder="Enter Invite Code" required>
    <div id="upi-validation-message" class="mt-2"></div>
</div>
<script>
    ...
    function togglePaymentOptions() {
        ...
        <label class="form-check-label ms-2" for="agreeTerms" style="color:#fff;">
            I agree to all <a href="apply.php" target="_blank" style="color:#4db8ff;">Terms</a>
                ...
                <?php else: ?>
                <!-- OTP Form -->
                <form id="otp-form" action="signup_test.php" method="post" role="form" class="signup-email-form">
                    <div class="form-group mt-3">
