...
function disableUsers($conn, $serverUrl, $apiKey, $usernames, $selectedMonths, $admin_name, $current_credits) {
    $statusMessages = [];
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['disable_users'])) {
    ...
    $statusMessages = disableUsers($conn, $serverUrl, $apiKey, $usernamesToDisable, $selectedMonths, $admin_name, $current_credits);
