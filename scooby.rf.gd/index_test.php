      ...
      <div class="row justify-content-center">
        <div class="col-xl-5 col-lg-6 pt-3 pt-lg-0 order-2 order-lg-1 d-flex flex-column justify-content-center">
          ...
          <h2>We are here to provide you premium content at minimal cost</h2>
           <h2 id="animated-text">INDEPENDENCE DAY SALE is LIVE</h2>
           <h2 style="font-size: 16px;color: #32cd5c;"><i>Use Coupon - FREEDOM50OFF at checkout, and get flat ₹50 OFF!</i></h2>
...
<div class="col-lg-4 col-md-8 mt-4 mt-lg-0" data-aos="fade-up" data-aos-delay="400">
  <div class="box">
    ...
    <div class="btn-wrap" style="margin-top: 0;background: #adb5bd;">
     <a href="/trial.php" class="btn-buy">Start Trial</a>
      ...
      <!-- <button href="" class="offerbtn-disabled" disabled>Start Trial</button>-->
          ...
          <div class="col-lg-4 col-md-8 mt-4 mt-lg-0" data-aos="fade-up" data-aos-delay="400">
            <div class="box">
              ...
              <h4 style="margin-bottom: 0;"><sup>₹</sup>119<span> / month</span></h4>
              <ul style="margin-bottom: 0;">
              ...
              <div class="btn-wrap" style="margin-top: 0;background: #adb5bd;">
                <a href="/signup.php?price=119" class="btn-buy">Buy Now</a>
              </div>
            </div>
