      ...
      <div class="row justify-content-center">
        <div class="col-xl-5 col-lg-6 pt-3 pt-lg-0 order-2 order-lg-1 d-flex flex-column justify-content-center">
          ...
          <h2>We are here to provide you premium content at minimal cost</h2>
           <h2 id="animated-text">REPUBLIC DAY SALE is LIVE, Watch at ₹89 only.</h2>
           <h2 style="font-size: 16px;color: #32cd5c;"><i> No coupon code required!</i></h2>
    <!--<h2 style="font-size: 16px;" class="<?php echo $is_logged_in ? 'hidden' : ''; ?>"><i>Offer Ends on 15th July</i></h2>-->
          <div>
<a href="<?php echo $is_logged_in ? 'http:stv1.xyz:53570' : '#pricing'; ?>" class="btn-get-started scrollto"  target="_blank"><?php echo $is_logged_in ? 'Watch Now' : 'Subscribe Now'; ?></a>
          </div>
        </div>
        <div class="col-xl-4 col-lg-6 order-1 order-lg-2 hero-img" data-aos="zoom-in" data-aos-delay="150">
          <img src="assets/img/logo_ott.webp" class="img-fluid animated" alt="" style="border-radius: 20px;">
        </div>
      </div>
    </div>
    ...
    <section id="pricing" class="pricing section-bg" style="background: linear-gradient(to bottom right, #3b3b3b, #202020);color:#fff;">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          ...
          <p><a href="https://youtu.be/RQNW8Pd5s98" target="_blank">How to buy?</a> 🙂</p>
        </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-md-8 mt-4 mt-md-0" data-aos="fade-up" data-aos-delay="200">
            <div class="box featured">
              <h3 style="background: linear-gradient(to bottom, #7FFF00, #32CD32);">Starter (49% OFF)</h3>
              <h4 style="margin-bottom: 0;"><sup>₹</sup>89<span> / month</span></h4>
              <ul style="margin-bottom: 0;">
                <li class="na" style="color:#e03131;">₹299/mon</li>
              ...
              <div class="btn-wrap" style="margin-top: 0;background: #adb5bd;">
                <a href="/signup.php?price=89" class="btn-buy">Buy Now</a>
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-8 mt-4 mt-lg-0" data-aos="fade-up" data-aos-delay="400">
            <div class="box">
              ...
              <h3 style="background: linear-gradient(to bottom, #FFD700, #FFA500);">Premium (51% OFF)</h3>
              <h4 style="margin-bottom: 0;"><sup>₹</sup>99<span> / month</span></h4>
              <ul style="margin-bottom: 0;">
                <li class="na" style="color:#e03131;">₹400/mon</li>
                <li>TV, Laptop, & Mobile</li>
                <li>Ads-Free</li>
                <li>Unlimited ⬇️</li>
                <li>All Premium content</li>
          ...
          <div class="col-lg-3 col-md-6 footer-links">
            ...
            <ul>
              ...
              <li><i class="bx bx-chevron-right"></i> <a href="support.php">Support</a></li>
                    <li><i class="bx bx-chevron-right"></i> <a href="SPP/apply.php">Affiliate Program</a></li>
