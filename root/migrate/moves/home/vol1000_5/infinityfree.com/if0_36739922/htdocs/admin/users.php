...
<section class="inner-page blog-body" style=" padding: 5px 0;">
  ...
  <section class="contact section-bg">
    ...
    <thead>
        <tr>
            ...
            <th>Email <button type="button" class="btn btn-sm btn-primary" id="copyEmailsBtn">Copy</button></th> 
             <?php if ($users_plan_expired == 'paid_users' || $users_plan_expired == 'trial_users' || $users_plan_expired == 'guest_users' || $users_plan_expired == 'Payment not made' || $users_plan_expired == 'All Users') { ?>
                 <th>Username</th>
                 <th>Created</th>
                 <th>Valid For</th>
                 <th>Plan or Paid</th>
                <th>Txn ID</th>
                 <th class="hidden">Pass</th>
            <?php } ?>
            <th>Plan Expiry</th>
    ...
    <tbody id="userTableBody">
        <?php if ($result) {
                                        while ($user = $result->fetch_assoc()) {  if ($users_plan_expired == 'paid_users') {
...
?></td>
                                                    ...
                                                    <td class=" hidden"><input type="password" class="form-control password-input" value="<?php echo htmlspecialchars($user['id']); ?>" disabled><button class="btn btn-sm btn-outline-primary toggle-password" type="button"><i class="fa fa-eye" id="togglePassword"></i></button></td>
                                                <?php } ?>  
