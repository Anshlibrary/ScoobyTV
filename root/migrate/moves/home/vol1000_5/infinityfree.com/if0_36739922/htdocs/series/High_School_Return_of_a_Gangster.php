...
$series_id = 2; // Replace with the actual series ID or fetch dynamically
$file_name = 'High_School_Return_of_a_Gangster.php';
...
<head>
  ...
  <title>High School Return of a Gangster (2024)</title>
  <meta content="" name="High School Return of a Gangster (2024)">
  <meta content="" name="High School Return of a Gangster (2024)">
...
<section class="inner-page blog-body">
  <div class="container">
   <h2 style="text-align: left;">High School Return of a Gangster (2024)</h2> <p style="text-align: right;"> views: <?php echo $views_count; ?></p>
  <h3 style="text-align: left;"></h3>
  
  <p>
  Kim Deuk Pal, a 47-year-old enforcer, ranks second in command within his gang. Despite his lack of formal education, a consequence of his impoverished upbringing, Deuk Pal harbors a deep desire to attend university. Driven by this dream, he has been quietly studying, though the path is far from easy.

One fateful day, he encounters a desperate young man named Song Yi Heon, on the verge of ending his life. In a twist of fate, Deuk Pal’s soul is transferred into the body of the 19-year-old high schooler. As Deuk Pal navigates life in this new, younger form, he discovers that Yi Heon is a victim of relentless bullying, pushing him to the brink of suicide.

Now inhabiting Yi Heon's body, Deuk Pal decides to confront the bullies, seeking justice on behalf of the tormented teenager. Along the way, he befriends Choi Se Kyung, a seemingly ideal student who hides his own dark secret—he is subjected to domestic abuse by his father. Together, they navigate the turbulent waters of high school, each battling their own demons.
</p>
  
  <img style="display: block; margin-left: auto; margin-right: auto; max-width: 100%; height: auto;border-radius:10px;cursor: pointer;" src="" alt="High_School_Return_of_a _Gangster 2024" data-toggle="modal" data-target="#signupModal">
  </div>
