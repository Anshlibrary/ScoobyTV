...
echo '<span style="background-color:#fa5252; color: #fff;">Plan Expired</span> <a href="payment_v3.php" class="btn btn-buy">Renew Now</a>';
} 
else {
    if ($user['purchase'] === 'Payment not made') {
    $classdata='hidden';
// If purchase is 'Payment not made', show 'Plan not Active' in red
echo '<span style="background-color:#fa5252; color: #fff;">Plan not Active</span> <a href="payment_v3.php" class="btn btn-buy">Pay Now</a>';
  }
    ...
    echo '<span style="margin-left:39px;">please wait for sometime...</span>';
     echo '<script type="text/javascript">
        ...
        if ($user['txn_id'] === "1_day_trial") 
        { 
             $classdata='hidden';
echo '<span style="color:#fff;font-weight:bold;">Plan Active [ 1 Day Trial ]</span><ul>
        <li>Exclusive Content not available on trial, so you will see Request button. <a href="pay" style="" class="">Subscribe</a> to Unlock </li>
        <li>Click "Open Scoobytv OTT" to Watch Content</li>
        <li>Fill <b>Username</b> on OTT page not <b>Email id</b></li>
         </ul>
        </td></tr>';
echo '<tr><th></th><td><a href="http://stv1.xyz:53575" style="margin-left:10px;" class="btn btn-buy">Open ScoobyTV OTT</a>';
echo '<p></p><a style="margin-top:30px;margin-left:10px;font-weight:bold;" href="#paidModal" data-toggle="modal" data-target="#paidModal">How to download app? <img src="assets/img/google-play.png" alt="Icon" style="width:20px;height:20px;vertical-align:middle;margin-left:5px;"><img src="assets/img/ios.png" alt="Icon" style="width:20px;height:20px;vertical-align:middle;margin-left:5px;"><img src="assets/img/windows.png" alt="Icon" style="width:20px;height:20px;vertical-align:middle;margin-left:5px;"></a>';
...
echo '<span style="background-color:#1fff1f; color: #fff;font-weight:bold;">Plan Active</span><ul>
        <li>Click "Open Scoobytv OTT" to Watch Content</li>
        <li>Fill <b>Username</b> on OTT page not Email id</li>
         </ul>
        </td></tr>';
        echo '<tr><th></th><td><a href="http://stv1.xyz:53575" style="margin-left:10px;" class="btn btn-buy">Open ScoobyTV OTT</a>';
        echo '<p></p><a style="margin-top:30px;margin-left:10px;font-weight:bold;" href="#how-to-watch" onclick="scrollToHowToWatch()">How to download app? <img src="assets/img/google-play.png" alt="Icon" style="width:20px;height:20px;vertical-align:middle;margin-left:5px;"><img src="assets/img/ios.png" alt="Icon" style="width:20px;height:20px;vertical-align:middle;margin-left:5px;"><img src="assets/img/windows.png" alt="Icon" style="width:20px;height:20px;vertical-align:middle;margin-left:5px;"></a>';
 echo '<script type="text/javascript">
...
echo '<span style="background-color:#fa5252; color: #fff;">Payment Verification Failed.</span> <a href="payment_v3.php" class="btn btn-buy">Pay Now</a>'; }}?>
</td>
</tr>
...
<div class="modal fade" id="paidModal" tabindex="-1" role="dialog" aria-labelledby="paidModalLabel" aria-hidden="true" style="top: 30%;">
    <div class="modal-dialog" role="document">
        <div class="modal-content" style="background-color: #343a40;">
            <div class="modal-body">
                <p class="">App is available for paid users only.<br>
                However you can still watch content on browser by clicking on "Open ScoobyTV OTT".</p>
                <div class="mb-3">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal" style="margin-left: 20px;">Close</button>
                     <a href="pay" class="btn btn-primary" style="margin-left: 20px;">Buy Plan</a>
...
<section id="" class="section-bg p-1 <?php echo htmlspecialchars($classdata); ?>" >
    <div class="container profile-container" data-aos="fade-up">
        ...
        <!-- Main Section 1: How to watch in Mobile App -->
        <div class="profile-header" style="text-align:left;">
            <h2 class="mt-3">
                <b>
                    <a href="#collapse1" data-toggle="collapse" class="collapse-toggle" 
                       onclick="toggleSection('collapse1')">
                        1. How to watch in Mobile App?
                    </a>
                    <i id="icon1" class="fas fa-plus-circle"></i>
                </b>
            </h2>
            <div id="collapse1" class="collapse show">
                <ul>
                    <li>Please wait for a few minutes to activate your OTT-ID.</li>
                    <li>Once activated, click the "Go to ScoobyTV" button.</li>
                    <li>Log in using your profile credentials to access the content.</li>
                    <li><b>For better experience, download our app:</b></li>
                </ul>
                <div class="d-flex justify-content-center" style="align-items: center;gap:20px;">
                    <a href="https://play.google.com/store/apps/details?id=dev.jdtech.jellyfin" target="_blank">
                        <img src="assets/img/playstore.png" alt="Icon" style="width:140px;">
                    </a>
                    <a href="https://apps.apple.com/us/app/jellyfin-mobile/id1480192618" target="_blank">
                        <img src="assets/img/applestore.png" alt="Icon" style="width:140px;">
                    </a>
                </div>
                <!-- Add more content for mobile app here -->
            </div>
        </div>

        <!-- Main Section 2: How to watch on TV -->
        <div class="profile-header" style="text-align:left;">
            <h2 class="mt-3">
                <b>
                    <a href="#collapse2" data-toggle="collapse" class="collapse-toggle"
                       onclick="toggleSection('collapse2')">
                        2. How to watch on TV?
                    </a>
                    <i id="icon2" class="fas fa-plus-circle"></i>
                </b>
            </h2>
            <div id="collapse2" class="collapse">
                <span>Download the Jellyfin app from the Playstore in Android TV or Smart TV. Use the IP: <b>stv1.xyz:53570</b>.</span>
                <!-- Add more content for TV here -->
            </div>
        </div>

        <!-- Main Section 3: How to watch on Laptop -->
        <div class="profile-header" style="text-align:left;">
            <h2 class="mt-3">
                <b>
                    <a href="#collapse3" data-toggle="collapse" class="collapse-toggle" 
                       onclick="toggleSection('collapse3')">
                        3. How to watch on Laptop?
                    </a>
                    <i id="icon3" class="fas fa-plus-circle"></i>
                </b>
            </h2>
            <div id="collapse3" class="collapse">
                <ul>
                    <li>Click "Go to ScoobyTV" and use your profile credentials to log in.</li>
                    <li>For the best experience, download Jellyfin Media Player for your laptop or PC.</li>
                </ul>
                <!-- Add more content for laptop here -->
            </div>
        </div>
    </div>
</section>
...
<script>
    function toggleSection(sectionId) {
        ...
        // Toggle the clicked section and icon
        const collapseElement = document.getElementById(sectionId);
        collapseElement.classList.toggle('show');
        const icon = collapseElement.previousElementSibling.querySelector('i');
...
<!-- Add full jQuery before Bootstrap -->
