...
<body>
    ...
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="nav-link scrollto" href="#movies">Movies</a></li>
  ...
  <section id="hero" class="d-flex align-items-center">
    ...
    <div class="container-fluid" data-aos="fade-up">
      <div class="row justify-content-center">
        <div class="col-xl-5 col-lg-6 pt-3 pt-lg-0 order-2 order-lg-1 d-flex flex-column justify-content-center">
          ...
          <h2 id="animated-text">Apka Apna Interactive TV</h2>
    ...
    <!--  <h2 style="font-size: 16px;" class="<?php echo $is_logged_in ? 'hidden' : ''; ?>"><i>1 day free trial, Offer Ends on 15th July</i></h2>-->
          <div>
<a href="<?php echo $is_logged_in ? 'http:stv1.xyz:53570' : '#pricing'; ?>" class="btn-get-started scrollto"><?php echo $is_logged_in ? 'Watch Now' : 'Subscribe Now'; ?></a>
          </div>
        </div>
  ...
  <main id="main">
    ...
    <section id="testimonials" class="testimonials section-bg" style="background-color: #141414;padding: 10px 0;margin: 10px 10px;">
      <div class="container" data-aos="fade-up" id="movies">
        ...
        <div class="testimonials-slider swiper" data-aos="fade-up" data-aos-delay="100">
          <div class="swiper-wrapper" id="movies-slider">
        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-md-8 mt-4 mt-md-0" data-aos="fade-up" data-aos-delay="200">
            <div class="box featured">
              <h3 style="background: linear-gradient(to bottom, #7FFF00, #32CD32);">Starter (76% OFF)</h3>
              <h4 style="margin-bottom: 0;"><sup>₹</sup>49<span> / month</span></h4>
              <ul style="margin-bottom: 0;">
                ...
                <li>1 Device</li>
                <li style="padding-bottom:0;">1080P Quality</li>
              ...
              <div class="btn-wrap" style="margin-top: 0;background: #adb5bd;">
                <a href="/signup.php?price=49" class="btn-buy">Buy Now</a>
              </div>
            </div>
          </div>
          <div class="col-lg-4 col-md-8 mt-4 mt-lg-0" data-aos="fade-up" data-aos-delay="400">
            <div class="box">
              ...
              <h3 style="background: linear-gradient(to bottom, #FFD700, #FFA500);">Premium (77% OFF)</h3>
              <h4 style="margin-bottom: 0;"><sup>₹</sup>69<span> / month</span></h4>
              <ul style="margin-bottom: 0;">
              ...
              <div class="btn-wrap" style="margin-top: 0;background: #adb5bd;">
                <a href="/signup.php?price=69" class="btn-buy">Buy Now</a>
              </div>
            </div>
...
<div class="col-lg-4 col-md-8 mt-4 mt-lg-0" data-aos="fade-up" data-aos-delay="400">
  <div class="box">
    <span class="advanced">Free Trail</span>
    ...
    <div class="btn-wrap" style="margin-top: 0;background: #adb5bd;">
      <button href="/trial.php" class="offerbtn-disabled" disabled>Ended</button>
    </div>
  </div>
          ...
          <ul>
            <li data-aos="fade-up" data-aos="fade-up" data-aos-delay="100">
              ...
              <div id="faq-list-1" class="collapse show" data-bs-parent=".faq-list">
                <p>
                ScoobyTV stands out by offering a personalized viewing experience through our content request feature. In addition to our extensive library of movies and web series, if you can't find the content you're looking for, you can simply request it. Our team will work to add the requested movie or web series to our collection, ensuring you always have access to the content you want to watch. This unique feature transforms your viewing experience into a customizable TV, tailored to your preferences.
                </p>
              </div>
            </li>
            ...
            <li data-aos="fade-up" data-aos-delay="200">
              <i class="bx bx-help-circle icon-help"></i> <a data-bs-toggle="collapse" data-bs-target="#faq-list-2" class="collapsed">Can I download Movies, Web Series and TV Shows for offline viewing? <i class="bx bx-chevron-down icon-show"></i><i class="bx bx-chevron-up icon-close"></i></a>
...
<script>
 ...
 initializeSwiperWithFallback('movies-slider', 'assets/img/movie');
 initializeSwiperWithFallback('series-slider', 'assets/img/series');

  fetch(TMDB_API_URL)
    .then(response => response.json())
    .then(data => {
      initializeSwiper(data.results); // Slice the array to show only first 10 movies
    })
