   ...
   <section id="signup" class="contact section-bg" style="background: linear-gradient(45deg, rgba(59, 59, 59, 0.9) 0%, rgba(32, 32, 32, 0.9) 100%);">
    <div class="container" data-aos="fade-up">
        <div class="section-title">
            ...
            <?php if (isset($_SESSION['otp_sent'])): ?>
                <form id="edit-email-form" action="trial.php" method="post" style="display:inline;">
        ...
        <div class="row <?php echo $signup_class; ?>">
            <div class="col-lg-12">
                ...
                <form id="signup-form" action="trial.php" method="post" role="form" class="signup-email-form">
                    <div class="row">
    ...
    if (emailPattern.test(emailInput)) {
        ...
        emailError.classList.remove('d-none');
                ...
                <!-- OTP Form -->
                <form id="otp-form" action="trial.php" method="post" role="form" class="signup-email-form">
                    <div class="form-group mt-3">
